...
ifeq ($(GIY_NT_COPY_BITS),)
ifneq (,$(filter $(OPT_GC),giy giyol))
...
ifneq ($(GIY_NT_COPY_BITS),)
CPPFLAGS += -DGIY_NT_COPY_BITS=$(GIY_NT_COPY_BITS)
ifeq ($(GIY_NT_COPY_BITS),256)
CXXFLAGS += -mavx2
endif
endif

ifneq ($(GIY_OLD_SLOT_NT_STORE),)
CPPFLAGS += -DGIY_OLD_SLOT_NT_STORE=$(GIY_OLD_SLOT_NT_STORE)
endif

ifneq ($(GIY_FORCE_NT_COPY),)
CPPFLAGS += -DGIY_FORCE_NT_COPY=$(GIY_FORCE_NT_COPY)
endif
...
ifeq ($(GIY_RSET_READ_SLOT_AT_GC),true)
CPPFLAGS += -DGIY_RSET_READ_SLOT_AT_GC=1
else ifeq ($(GIY_RSET_READ_SLOT_AT_GC),false)
CPPFLAGS += -DGIY_RSET_READ_SLOT_AT_GC=0
endif

ifneq ($(GC_FT_SLOT_SET_BYTES),)
CPPFLAGS += -DGC_FT_SLOT_SET_BYTES=$(GC_FT_SLOT_SET_BYTES)
endif

ifneq ($(GIY_GC_STACK_BYTES),)
CPPFLAGS += -DGIY_GC_STACK_BYTES=$(GIY_GC_STACK_BYTES)
endif

ifneq ($(GIY_LOCAL_PADDING_BYTES),)
CPPFLAGS += -DGIY_LOCAL_PADDING_BYTES=$(GIY_LOCAL_PADDING_BYTES)
endif

ifneq ($(CHENEY_LOCAL_PADDING_BYTES),)
CPPFLAGS += -DCHENEY_LOCAL_PADDING_BYTES=$(CHENEY_LOCAL_PADDING_BYTES)
endif

ifeq ($(GIY_SB),true)
CPPFLAGS += -DUSE_GIYSB=1
endif

ifneq ($(GIYSB_TINY_BATCH),)
CPPFLAGS += -DGIYSB_TINY_BATCH=$(GIYSB_TINY_BATCH)
endif

ifneq ($(GIYSB_STAGING_BYTES),)
CPPFLAGS += -DGIYSB_STAGING_BYTES=$(GIYSB_STAGING_BYTES)
endif

ifneq ($(GIYSB_SMALL_OBJECT_MAX_BYTES),)
CPPFLAGS += -DGIYSB_SMALL_OBJECT_MAX_BYTES=$(GIYSB_SMALL_OBJECT_MAX_BYTES)
endif

ifneq ($(GIYSB_TINY_OBJECT_MAX_BYTES),)
CPPFLAGS += -DGIYSB_TINY_OBJECT_MAX_BYTES=$(GIYSB_TINY_OBJECT_MAX_BYTES)
endif

ifneq ($(GIYSB_TINY_TABLE_BYTES),)
CPPFLAGS += -DGIYSB_TINY_TABLE_BYTES=$(GIYSB_TINY_TABLE_BYTES)
endif

ifneq ($(GIYSB_SMALL_OLD_RATIO),)
CPPFLAGS += -DGIYSB_SMALL_OLD_RATIO=$(GIYSB_SMALL_OLD_RATIO)
endif

ifeq ($(GIYSB_PROFILE),true)
CPPFLAGS += -DGIYSB_PROFILE=1
endif

ifneq ($(GIY_JSOBJECT_PRECISE_SCAN),)
CPPFLAGS += -DGIY_JSOBJECT_PRECISE_SCAN=$(GIY_JSOBJECT_PRECISE_SCAN)
endif

ifneq ($(GIY_JSOBJECT_PRECISE_ARRAY),)
CPPFLAGS += -DGIY_JSOBJECT_PRECISE_ARRAY=$(GIY_JSOBJECT_PRECISE_ARRAY)
endif

ifneq ($(GIY_JSOBJECT_SHAPE_ONLY_SCAN),)
CPPFLAGS += -DGIY_JSOBJECT_SHAPE_ONLY_SCAN=$(GIY_JSOBJECT_SHAPE_ONLY_SCAN)
endif

ifneq ($(GIY_JSOBJECT_TYPE_AWARE_SCAN),)
CPPFLAGS += -DGIY_JSOBJECT_TYPE_AWARE_SCAN=$(GIY_JSOBJECT_TYPE_AWARE_SCAN)
endif

ifneq ($(GIY_JSOBJECT_TYPE_AWARE_ARRAY),)
CPPFLAGS += -DGIY_JSOBJECT_TYPE_AWARE_ARRAY=$(GIY_JSOBJECT_TYPE_AWARE_ARRAY)
endif

ifneq ($(GIY_JSOBJECT_TYPE_AWARE_BOXED_PRIMITIVE),)
CPPFLAGS += -DGIY_JSOBJECT_TYPE_AWARE_BOXED_PRIMITIVE=$(GIY_JSOBJECT_TYPE_AWARE_BOXED_PRIMITIVE)
endif

ifneq ($(GIY_JSOBJECT_ARRAY_FAST_PATH),)
CPPFLAGS += -DGIY_JSOBJECT_ARRAY_FAST_PATH=$(GIY_JSOBJECT_ARRAY_FAST_PATH)
endif

ifneq ($(GIY_JSOBJECT_ARRAY_SKIP_SIZE),)
CPPFLAGS += -DGIY_JSOBJECT_ARRAY_SKIP_SIZE=$(GIY_JSOBJECT_ARRAY_SKIP_SIZE)
endif

ifneq ($(GIY_JSOBJECT_PRECISE_MIN_SLOTS),)
CPPFLAGS += -DGIY_JSOBJECT_PRECISE_MIN_SLOTS=$(GIY_JSOBJECT_PRECISE_MIN_SLOTS)
endif

ifneq ($(GIY_JSOBJECT_LAYOUT_CACHE_ENTRIES),)
CPPFLAGS += -DGIY_JSOBJECT_LAYOUT_CACHE_ENTRIES=$(GIY_JSOBJECT_LAYOUT_CACHE_ENTRIES)
endif

ifneq ($(GIYOL_BATCH_BYTES),)
CPPFLAGS += -DGIYOL_BATCH_BYTES=$(GIYOL_BATCH_BYTES)
endif

ifneq ($(GIYOL_SORT_BATCH),)
CPPFLAGS += -DGIYOL_SORT_BATCH=$(GIYOL_SORT_BATCH)
endif

ifneq ($(GIYOL_WORKSPACE_BATCH_ENTRIES),)
CPPFLAGS += -DGIYOL_WORKSPACE_BATCH_ENTRIES=$(GIYOL_WORKSPACE_BATCH_ENTRIES)
endif

ifneq ($(GIYOL_ADAPTIVE_BATCH),)
CPPFLAGS += -DGIYOL_ADAPTIVE_BATCH=$(GIYOL_ADAPTIVE_BATCH)
endif

ifneq ($(GIYOL_STAGING_COPY),)
CPPFLAGS += -DGIYOL_STAGING_COPY=$(GIYOL_STAGING_COPY)
endif

ifneq ($(GIYOL_TINY_STAGING),)
CPPFLAGS += -DGIYOL_TINY_STAGING=$(GIYOL_TINY_STAGING)
endif

ifneq ($(GIYOL_TINY_STAGING_BYTES),)
CPPFLAGS += -DGIYOL_TINY_STAGING_BYTES=$(GIYOL_TINY_STAGING_BYTES)
endif

ifneq ($(GIYOL_TINY_FLUSH_BYTES),)
CPPFLAGS += -DGIYOL_TINY_FLUSH_BYTES=$(GIYOL_TINY_FLUSH_BYTES)
endif

ifneq ($(GIYOL_TINY_MAX_OBJECT_BYTES),)
CPPFLAGS += -DGIYOL_TINY_MAX_OBJECT_BYTES=$(GIYOL_TINY_MAX_OBJECT_BYTES)
endif

ifneq ($(GIYOL_FORCE_TINY_TAIL_NT),)
CPPFLAGS += -DGIYOL_FORCE_TINY_TAIL_NT=$(GIYOL_FORCE_TINY_TAIL_NT)
endif

ifneq ($(GIYOL_DIRECT_NONTINY_NT),)
CPPFLAGS += -DGIYOL_DIRECT_NONTINY_NT=$(GIYOL_DIRECT_NONTINY_NT)
endif

ifneq ($(GIYOL_DEFER_TINY_STAGING),)
CPPFLAGS += -DGIYOL_DEFER_TINY_STAGING=$(GIYOL_DEFER_TINY_STAGING)
endif
...
ifeq ($(OPT_GC),giyol)
	CPPFLAGS+=-DUSE_NATIVEGC=1 -DCACHE_CHENEY -DUSE_REMEMBERED_SET -DUSE_GIY_MINOR -DUSE_GIYOL
	CXX_FILES+=giy_dram_manager.cc giy_rset.cc GiY.cc
	OFILES+=giy_dram_manager.o giy_rset.o GiY.o
    HFILES+=cache_dram_manager.h
endif
